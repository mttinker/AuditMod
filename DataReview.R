DataReview = function(df,TargetCall){
filename = c("Sample_raw_dat7s.rdata")
# Data Review
library(gtools)
library(fitdistrplus)
# ASSUMES NEXT 2 LINES ALRADY EXECUTED in SHELL
...
save(df,Sitelist,Outcomes,ratings,Nsite,Nobs,file=filename)
